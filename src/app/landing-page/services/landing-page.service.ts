...
export class LandingPageService {
  ...
  getAllProduct(data: any):Observable<ProductResponse[]>{
    return this.httpClient.post<ProductResponse[]>(`${environment.api_domain}/Product/get-all-product`,data).pipe(
    )
  }
  ...
  getCategoryByOption = (data: any) => this.httpClient.post<GetCategoryResponse>(`${environment.api_domain}/Category/get-category-by-option`,data);
